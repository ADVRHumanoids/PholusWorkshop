...
#include <PholusPlugin_rt_plugin.h>

/* Specify that the class XBotPlugin::PholusPlugin is a XBot RT plugin with name "PholusPlugin" */
REGISTER_XBOT_PLUGIN(PholusPlugin, XBotPlugin::PholusPlugin)

namespace XBotPlugin {

bool PholusPlugin::init_control_plugin(std::string path_to_config_file,
...
void PholusPlugin::on_start(double time)
{
...
void PholusPlugin::control_loop(double time, double period)
{
